# encoding: utf-8
# module win32api
# from C:\Users\baozi\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\site-packages\win32\win32api.pyd
# by generator 1.147
...
def SetWindowWord(*args, **kwargs): # real signature unknown
    pass
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000246AECAD8C0>'

__spec__ = None # (!) real value is "ModuleSpec(name='win32api', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000246AECAD8C0>, origin='C:\\\\Users\\\\baozi\\\\AppData\\\\Local\\\\Packages\\\\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\\\\LocalCache\\\\local-packages\\\\Python313\\\\site-packages\\\\win32\\\\win32api.pyd')"
