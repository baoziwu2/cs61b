...
class Philox(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x00000232ACDED120>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x00000232ACDFCDD0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._philox', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x00000232ACDFCDD0>, origin='C:\\\\Users\\\\baozi\\\\AppData\\\\Local\\\\Packages\\\\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\\\\LocalCache\\\\local-packages\\\\Python313\\\\site-packages\\\\numpy\\\\random\\\\_philox.cp313-win_amd64.pyd')"
