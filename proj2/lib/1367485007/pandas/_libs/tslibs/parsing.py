...
# from C:\Users\baozi\AppData\Local\Packages\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\LocalCache\local-packages\Python313\site-packages\pandas\_libs\tslibs\parsing.cp313-win_amd64.pyd
# by generator 1.147
...
class tzoffset(__datetime.tzinfo):
    ...
    _cache_lock = None # (!) real value is '<unlocked _thread.lock object at 0x000002A858872B10>'
    _TzOffsetFactory__instances = None # (!) real value is '<WeakValueDictionary at 0x2a858b0e520>'
    _TzOffsetFactory__strong_cache = OrderedDict()
    _TzOffsetFactory__strong_cache_size = 8
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'dateutil.tz.tz', '__firstlineno__': 132, '__doc__': '\\nA simple class for representing a fixed offset from UTC.\\n\\n:param name:\\n    The timezone name, to be returned when ``tzname()`` is called.\\n:param offset:\\n    The time zone offset in seconds, or (since version 2.6.0, represented\\n    as a :py:class:`datetime.timedelta` object).\\n', '__init__': <function tzoffset.__init__ at 0x000002A858BF6480>, 'utcoffset': <function tzoffset.utcoffset at 0x000002A858BF7BA0>, 'dst': <function tzoffset.dst at 0x000002A858BF7C40>, 'tzname': <function tzoffset.tzname at 0x000002A858BF7CE0>, 'fromutc': <function tzoffset.fromutc at 0x000002A858BF7E20>, 'is_ambiguous': <function tzoffset.is_ambiguous at 0x000002A858BF7EC0>, '__eq__': <function tzoffset.__eq__ at 0x000002A858BF7F60>, '__hash__': None, '__ne__': <function tzoffset.__ne__ at 0x000002A858BF0040>, '__repr__': <function tzoffset.__repr__ at 0x000002A858BF00E0>, '__reduce__': <method '__reduce__' of 'object' objects>, '__static_attributes__': ('_name', '_offset'), '__dict__': <attribute '__dict__' of 'tzoffset' objects>, '__weakref__': <attribute '__weakref__' of 'tzoffset' objects>, '_TzOffsetFactory__instances': <WeakValueDictionary at 0x2a858b0e520>, '_TzOffsetFactory__strong_cache': OrderedDict(), '_TzOffsetFactory__strong_cache_size': 8, '_cache_lock': <unlocked _thread.lock object at 0x000002A858872B10>})"
    __firstlineno__ = 132
    __hash__ = None
...
class _dateutil_tzutc(__datetime.tzinfo):
    ...
    **Examples:**
    ...
    __dict__ = None # (!) real value is 'mappingproxy({\'__module__\': \'dateutil.tz.tz\', \'__firstlineno__\': 41, \'__doc__\': "\\nThis is a tzinfo object that represents the UTC time zone.\\n\\n**Examples:**\\n\\n.. doctest::\\n\\n    >>> from datetime import *\\n    >>> from dateutil.tz import *\\n\\n    >>> datetime.now()\\n    datetime.datetime(2003, 9, 27, 9, 40, 1, 521290)\\n\\n    >>> datetime.now(tzutc())\\n    datetime.datetime(2003, 9, 27, 12, 40, 12, 156379, tzinfo=tzutc())\\n\\n    >>> datetime.now(tzutc()).tzname()\\n    \'UTC\'\\n\\n.. versionchanged:: 2.7.0\\n    ``tzutc()`` is now a singleton, so the result of ``tzutc()`` will\\n    always return the same object.\\n\\n    .. doctest::\\n\\n        >>> from dateutil.tz import tzutc, UTC\\n        >>> tzutc() is tzutc()\\n        True\\n        >>> tzutc() is UTC\\n        True\\n", \'utcoffset\': <function tzutc.utcoffset at 0x000002A858BF7600>, \'dst\': <function tzutc.dst at 0x000002A858BF76A0>, \'tzname\': <function tzutc.tzname at 0x000002A858BF7740>, \'is_ambiguous\': <function tzutc.is_ambiguous at 0x000002A858BF77E0>, \'fromutc\': <function tzutc.fromutc at 0x000002A858BF7920>, \'__eq__\': <function tzutc.__eq__ at 0x000002A858BF79C0>, \'__hash__\': None, \'__ne__\': <function tzutc.__ne__ at 0x000002A858BF7A60>, \'__repr__\': <function tzutc.__repr__ at 0x000002A858BF7B00>, \'__reduce__\': <method \'__reduce__\' of \'object\' objects>, \'__static_attributes__\': (), \'__dict__\': <attribute \'__dict__\' of \'tzutc\' objects>, \'__weakref__\': <attribute \'__weakref__\' of \'tzutc\' objects>, \'_TzSingleton__instance\': tzutc()})'
    __firstlineno__ = 41
    __hash__ = None
    __static_attributes__ = ()
...
class _timelex(object):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__module__': 'pandas._libs.tslibs.parsing', '__init__': <cyfunction _timelex.__init__ at 0x000002A858B8B1C0>, 'get_tokens': <cyfunction _timelex.get_tokens at 0x000002A858B8B280>, 'split': <classmethod(<cyfunction _timelex.split at 0x000002A858B8B340>)>, '__dict__': <attribute '__dict__' of '_timelex' objects>, '__weakref__': <attribute '__weakref__' of '_timelex' objects>, '__doc__': None})"


# variables with complex values

DEFAULTPARSER = None # (!) real value is '<dateutil.parser._parser.parser object at 0x000002A858BAD010>'

_DEFAULT_DATETIME = None # (!) real value is 'datetime.datetime(1, 1, 1, 0, 0)'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A858BBCF50>'

__pyx_capi__ = {
    'get_rule_month': None, # (!) real value is '<capsule object "PyObject *(PyObject *, int __pyx_skip_dispatch)" at 0x000002A858B141D0>'
    'parse_datetime_string': None, # (!) real value is '<capsule object "PyDateTime_DateTime *(PyObject *, int, int, NPY_DATETIMEUNIT *, __pyx_t_5numpy_int64_t *)" at 0x000002A858B14040>'
    'quarter_to_myear': None, # (!) real value is '<capsule object "PyObject *(int, int, PyObject *, int __pyx_skip_dispatch)" at 0x000002A858B14180>'
}

__spec__ = None # (!) real value is "ModuleSpec(name='pandas._libs.tslibs.parsing', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000002A858BBCF50>, origin='C:\\\\Users\\\\baozi\\\\AppData\\\\Local\\\\Packages\\\\PythonSoftwareFoundation.Python.3.13_qbz5n2kfra8p0\\\\LocalCache\\\\local-packages\\\\Python313\\\\site-packages\\\\pandas\\\\_libs\\\\tslibs\\\\parsing.cp313-win_amd64.pyd')"

__test__ = {
    'concat_date_cols (line 1146)': "\n    Concatenates elements from numpy arrays in `date_cols` into strings.\n\n    Parameters\n    ----------\n    date_cols : tuple[ndarray]\n\n    Returns\n    -------\n    arr_of_rows : ndarray[object]\n\n    Examples\n    --------\n    >>> dates=np.array(['3/31/2019', '4/31/2019'], dtype=object)\n    >>> times=np.array(['11:20', '10:45'], dtype=object)\n    >>> result = concat_date_cols((dates, times))\n    >>> result\n    array(['3/31/2019 11:20', '4/31/2019 10:45'], dtype=object)\n    ",
    'get_rule_month (line 1220)': "\n    Return starting month of given freq, default is December.\n\n    Parameters\n    ----------\n    source : str\n        Derived from `freq.rule_code` or `freq.freqstr`.\n\n    Returns\n    -------\n    rule_month: str\n\n    Examples\n    --------\n    >>> get_rule_month('D')\n    'DEC'\n\n    >>> get_rule_month('A-JAN')\n    'JAN'\n    ",
    'guess_datetime_format (line 883)': "\n    Guess the datetime format of a given datetime string.\n\n    Parameters\n    ----------\n    dt_str : str\n        Datetime string to guess the format of.\n    dayfirst : bool, default False\n        If True parses dates with the day first, eg 20/01/2005\n\n        .. warning::\n            dayfirst=True is not strict, but will prefer to parse\n            with day first (this is a known bug).\n\n    Returns\n    -------\n    str or None : ret\n        datetime format string (for `strftime` or `strptime`),\n        or None if it can't be guessed.\n\n    Examples\n    --------\n    >>> from pandas.tseries.api import guess_datetime_format\n    >>> guess_datetime_format('09/13/2023')\n    '%m/%d/%Y'\n\n    >>> guess_datetime_format('2023|September|13')\n    ",
}
