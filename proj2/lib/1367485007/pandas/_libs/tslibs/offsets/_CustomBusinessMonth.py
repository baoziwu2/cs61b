...
class _CustomBusinessMonth(BusinessMixin):
    ...
    cbday_roll = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x0000023690894F40>'
    month_roll = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x0000023690894EC0>'
    m_offset = None # (!) real value is '<pandas._libs.properties.CachedProperty object at 0x0000023690894F00>'
    _attributes = (
        'n',
        'normalize',
        'weekmask',
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000023690833290>'
