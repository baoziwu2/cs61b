...
class __loader__(object):
    ...
    _ORIGIN = 'built-in'
    __dict__ = None # (!) real value is "mappingproxy({'__module__': '_frozen_importlib', '__firstlineno__': 971, '__doc__': 'Meta path import for built-in modules.\\n\\nAll methods are either class or static methods to avoid the need to\\ninstantiate the class.\\n\\n', '_ORIGIN': 'built-in', 'find_spec': <classmethod(<function BuiltinImporter.find_spec at 0x000001EA49D83380>)>, 'create_module': <staticmethod(<function BuiltinImporter.create_module at 0x000001EA49D83420>)>, 'exec_module': <staticmethod(<function BuiltinImporter.exec_module at 0x000001EA49D834C0>)>, 'get_code': <classmethod(<function BuiltinImporter.get_code at 0x000001EA49D83600>)>, 'get_source': <classmethod(<function BuiltinImporter.get_source at 0x000001EA49D83740>)>, 'is_package': <classmethod(<function BuiltinImporter.is_package at 0x000001EA49D83880>)>, 'load_module': <classmethod(<function _load_module_shim at 0x000001EA49D82700>)>, '__static_attributes__': (), '__dict__': <attribute '__dict__' of 'BuiltinImporter' objects>, '__weakref__': <attribute '__weakref__' of 'BuiltinImporter' objects>})"
    __firstlineno__ = 971
