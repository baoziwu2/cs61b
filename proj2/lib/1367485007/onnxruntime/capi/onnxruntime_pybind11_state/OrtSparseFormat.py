...
class OrtSparseFormat(__pybind11_builtins.pybind11_object):
    """
    Members:
...
"""
    ...
    ORT_SPARSE_BLOCK_SPARSE = None # (!) real value is '<OrtSparseFormat.ORT_SPARSE_BLOCK_SPARSE: 4>'
    ORT_SPARSE_COO = None # (!) real value is '<OrtSparseFormat.ORT_SPARSE_COO: 1>'
    ORT_SPARSE_CSRC = None # (!) real value is '<OrtSparseFormat.ORT_SPARSE_CSRC: 2>'
    ORT_SPARSE_UNDEFINED = None # (!) real value is '<OrtSparseFormat.ORT_SPARSE_UNDEFINED: 0>'
    __entries = {
        'ORT_SPARSE_BLOCK_SPARSE': (
            None, # (!) real value is '<OrtSparseFormat.ORT_SPARSE_BLOCK_SPARSE: 4>'
            None,
        ),
        'ORT_SPARSE_COO': (
            None, # (!) real value is '<OrtSparseFormat.ORT_SPARSE_COO: 1>'
            None,
        ),
        'ORT_SPARSE_CSRC': (
            None, # (!) real value is '<OrtSparseFormat.ORT_SPARSE_CSRC: 2>'
            None,
        ),
        'ORT_SPARSE_UNDEFINED': (
            None, # (!) real value is '<OrtSparseFormat.ORT_SPARSE_UNDEFINED: 0>'
            None,
        ),
    }
    __members__ = {
