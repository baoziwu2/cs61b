...
class OrtMemType(__pybind11_builtins.pybind11_object):
    """
    Members:
...
"""
    ...
    CPU = None # (!) real value is '<OrtMemType.CPU_OUTPUT: -1>'
    CPU_INPUT = None # (!) real value is '<OrtMemType.CPU_INPUT: -2>'
    CPU_OUTPUT = None # (!) real value is '<OrtMemType.CPU_OUTPUT: -1>'
    DEFAULT = None # (!) real value is '<OrtMemType.DEFAULT: 0>'
    __entries = {
        'CPU': (
            None, # (!) real value is '<OrtMemType.CPU_OUTPUT: -1>'
            None,
        ),
        'CPU_INPUT': (
            None, # (!) real value is '<OrtMemType.CPU_INPUT: -2>'
            None,
        ),
        'CPU_OUTPUT': '<value is a self-reference, replaced by this string>',
        'DEFAULT': (
            None, # (!) real value is '<OrtMemType.DEFAULT: 0>'
            None,
        ),
    }
    __members__ = {
