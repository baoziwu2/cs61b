...
class SparseCsrView(__pybind11_builtins.pybind11_object):
    # no doc
    def inner(self): # real signature unknown; restored from __doc__
        """ inner(self: onnxruntime.capi.onnxruntime_pybind11_state.SparseCsrView) -> numpy.ndarray """
        pass

    def outer(self): # real signature unknown; restored from __doc__
