...
class OrtAllocatorType(__pybind11_builtins.pybind11_object):
    """
    Members:
...
"""
    ...
    INVALID = None # (!) real value is '<OrtAllocatorType.INVALID: -1>'
    ORT_ARENA_ALLOCATOR = None # (!) real value is '<OrtAllocatorType.ORT_ARENA_ALLOCATOR: 1>'
    ORT_DEVICE_ALLOCATOR = None # (!) real value is '<OrtAllocatorType.ORT_DEVICE_ALLOCATOR: 0>'
    __entries = {
        'INVALID': (
            None, # (!) real value is '<OrtAllocatorType.INVALID: -1>'
            None,
        ),
        'ORT_ARENA_ALLOCATOR': (
            None, # (!) real value is '<OrtAllocatorType.ORT_ARENA_ALLOCATOR: 1>'
            None,
        ),
        'ORT_DEVICE_ALLOCATOR': (
            None, # (!) real value is '<OrtAllocatorType.ORT_DEVICE_ALLOCATOR: 0>'
            None,
        ),
    }
    __members__ = {
